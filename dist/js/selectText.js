...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _splitText__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./splitText */ "./src/splitText.ts");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./util */ "./src/util.js");
/* harmony import */ var dom_inspector__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! dom-inspector */ "./node_modules/dom-inspector/dist/dom-inspector.min.js");
/* harmony import */ var dom_inspector__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(dom_inspector__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _FocusController__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./FocusController */ "./src/FocusController.ts");
...
const Pstyle = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].div `
    position: relative;
    display: inline;
...
`;
const TextRenderArea = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].div `
    position: relative;
    white-space: pre-wrap;
    overflow-wrap: word-wrap;
    margin:5%;
...
const SelectText = ({ updateState }) => {
    const listRef = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])([]);
    ...
    const global = Object(_Context__WEBPACK_IMPORTED_MODULE_5__["useGlobalState"])();
    let globalSplitWords = global.splitWords;
    const [splitWords, getSplitWords] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(globalSplitWords);
    ...
    const setTextOnce = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])((text) => {
        text ? setText(text) : null;
    }, []);
    const setSplitWords = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])((value) => {
    ...
    Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
        if (globalSplitWords) {
            ...
            const split = Object(_splitText__WEBPACK_IMPORTED_MODULE_1__["splitText"])(currentText, globalSplitWords);
            setTextOnce(split);
        }
    }, [globalSplitWords]);
    Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
        if (text) {
            text.forEach((_, i) => {
                listRef.current[i] = react__WEBPACK_IMPORTED_MODULE_0___default.a.createRef();
            });
        ...
        chrome.runtime.onMessage.addListener(async (request, sender, sendResponse) => {
            ...
            if (request.message === 'select') {
                if (!request.text) {
                    ...
                    const text = rawText;
                    const split = Object(_splitText__WEBPACK_IMPORTED_MODULE_1__["splitText"])(text, splitWords);
                    setTextOnce(split);
                ...
                if (navigator.clipboard) {
                    ...
                    navigator.clipboard.readText()
                        ...
                        const split = Object(_splitText__WEBPACK_IMPORTED_MODULE_1__["splitText"])(textContent, splitWords);
                        setTextOnce(split);
                        getTextData({ ...textData, sumWord: text.length });
                        updateState(true);
                    });
    ...
    let sentence = text ?
        text.map((result, index) => {
            ...
            */
            return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Pstyle, { key: String(index), ref: listRef.current[index], tabIndex: isEdit ? 1 : 0, "data-index": index, onKeyDown: (e) => handleKeyDown(e, index, listRef), onClick: (e) => click(e, listRef.current[index]), onMouseDown: (e) => click(e, listRef.current[index]), onBlur: (e) => blur(e, listRef.current), onFocus: (e) => focus(e, listRef.current[index].current), contentEditable: isEdit, suppressContentEditableWarning: true, blurFontColor: global.color ? global.color["fontColor"] : "gray", focusFontColor: global.color ? global.color["highlight"] : "black", shadow: global.color ? global.color["shadow"] : "gray" }, result);
        }) : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "no");
    ...
    const blur = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])((e, ref) => {
        e.preventDefault();
    ...
    const focus = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])((e, ref) => {
        ...
        Object(_FocusController__WEBPACK_IMPORTED_MODULE_6__["focusStore"])(ref);
        if (bottom > 500) {
            ref.scrollIntoView({
                block: 'center',
                behavior: "smooth"
    ...
    const handleKeyDown = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])((e, i, ref) => {
        const pos = Object(_util__WEBPACK_IMPORTED_MODULE_2__["getCaretPos"])();
    ...
    const editText = async () => {
        const inspector = new dom_inspector__WEBPACK_IMPORTED_MODULE_3___default.a();
        inspector.enable();
        document.addEventListener("click", async function domselect(e) {
            ...
            setRawText(domText);
            const textArray = Object(_splitText__WEBPACK_IMPORTED_MODULE_1__["splitText"])(domText, splitWords);
