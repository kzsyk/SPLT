...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/SelectText.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
/*!*************************!*\
  !*** ./src/Context.tsx ***!
  \*************************/
/*! exports provided: StyleContextProvider, useDispatch, useGlobalState */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StyleContextProvider", function() { return StyleContextProvider; });
...
const dispatchContext = react__WEBPACK_IMPORTED_MODULE_0___default.a.createContext((() => true));
const initContext = _reducer__WEBPACK_IMPORTED_MODULE_1__["storage"] ? _reducer__WEBPACK_IMPORTED_MODULE_1__["storage"] : _reducer__WEBPACK_IMPORTED_MODULE_1__["initStorage"];
const StyleContext = react__WEBPACK_IMPORTED_MODULE_0___default.a.createContext(initContext);
const StyleContextProvider = (props) => {
    const [state, dispatch] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useReducer"])(_reducer__WEBPACK_IMPORTED_MODULE_1__["reducerFunc"], initContext);
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(dispatchContext.Provider, { value: dispatch },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(StyleContext.Provider, { value: state }, props.children)));
};
const useDispatch = () => {
    return Object(react__WEBPACK_IMPORTED_MODULE_0__["useContext"])(dispatchContext);
};
const useGlobalState = () => {
    const state = Object(react__WEBPACK_IMPORTED_MODULE_0__["useContext"])(StyleContext)["style"];
    return state;
};
...
/***/ "./src/FocusController.ts":
/*!********************************!*\
  !*** ./src/FocusController.ts ***!
  \********************************/
/*! exports provided: focusStore, focusReturn */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "focusStore", function() { return focusStore; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "focusReturn", function() { return focusReturn; });
const list = [];
const focusStore = (ref) => {
    if (ref)
        list.push(ref);
};
const focusReturn = () => {
...
/* harmony import */ var dom_inspector__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! dom-inspector */ "./node_modules/dom-inspector/dist/dom-inspector.min.js");
/* harmony import */ var dom_inspector__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(dom_inspector__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _FocusController__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./FocusController */ "./src/FocusController.ts");
...
const Pstyle = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div `
    position: relative;
    display: inline;
...
`;
const TextRenderArea = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div `
    position: relative;
    white-space: pre-wrap;
    overflow-wrap: word-wrap;
    margin:5%;
    ...
    outline: none;
`;
const SelectText = ({ updateState }) => {
    let listRef = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])([]);
    const areaRef = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(null);
    const [textData, getTextData] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])({
        sumWord: 0,
        length: 0
    });
    const global = Object(_Context__WEBPACK_IMPORTED_MODULE_4__["useGlobalState"])();
    let globalSplitWords = global.splitWords;
    const [rawText, setRawText] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(null);
    const [text, setText] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(null);
    const [isEdit, setIsEdit] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false);
    let sentence = text ? text.map((result, index) => {
        ...
        */
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Pstyle, { key: String(index), ref: listRef.current[index], tabIndex: isEdit ? 1 : 0, "data-index": index, onKeyDown: (e) => handleKeyDown(e, index, listRef), onClick: (e) => click(e, listRef.current[index]), onMouseDown: (e) => click(e, listRef.current[index]), onBlur: (e) => blur(e), onFocus: (e) => focus(e, listRef.current[index].current), contentEditable: isEdit, suppressContentEditableWarning: true, blurFontColor: global.color ? global.color["fontColor"] : "gray", focusFontColor: global.color ? global.color["highlight"] : "black", shadow: global.color ? global.color["shadow"] : "gray" }, result);
    }) : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "no");
    ...
    Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
        if (text) {
            ...
            text.forEach((_, i) => { listRef.current[i] = react__WEBPACK_IMPORTED_MODULE_0___default.a.createRef(); });
            areaRef.current.focus();
            sentence = text ? text.map((result, index) => {
                listRef.current[index] = react__WEBPACK_IMPORTED_MODULE_0___default.a.createRef();
                //const getColor = () => Math.floor(Math.random() * 255)
                /*
                const style = {
                    color: `rgb(${getColor()},${getColor()},${getColor()})`,
    ...
    const callbackEdit = (isEditNow, ref, startPos) => {
        setIsEdit(isEditNow);
        if (ref && isEditNow) {
    ...
    const focus = (e, ref) => {
        e.preventDefault();
        if (ref) {
            const bottom = ref.getBoundingClientRect().top + window.pageYOffset;
            Object(_FocusController__WEBPACK_IMPORTED_MODULE_5__["focusStore"])(ref);
            if (bottom > 500) {
                ref.scrollIntoView({
                    block: 'center',
                    behavior: "smooth"
    ...
    const focusSentence = (ref, select) => {
        if (!ref.current[select])
            return;
        const currentDom = ref.current[select];
        if (currentDom) {
            currentDom.current.focus();
            const bottom = currentDom.current.getBoundingClientRect().top + window.pageYOffset;
            if (bottom > 500) {
    ...
    const handleKeyDown = (e, i, ref) => {
        if (e.key === "ArrowRight") {
            if (isEdit) {
                const pos = Object(_util__WEBPACK_IMPORTED_MODULE_1__["getCaretPos"])();
                const count = ref.current[i].current.innerText.length;
                if (pos === count) {
        ...
        if (e.key === "ArrowLeft") {
            if (isEdit) {
                ...
                if (pos === 0) {
                    focusSentence(ref, i - 1);
                    if (ref.current[i - 1]) {
                        callbackEdit(true, ref.current[i - 1].current, ref.current[i - 1].current.innerText.length);
                    }
                }
            }
            else {
    ...
    const selectDom = async () => {
        ...
        const inspector = new dom_inspector__WEBPACK_IMPORTED_MODULE_2___default.a();
        inspector.enable();
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(TextRenderArea, { ref: areaRef, tabIndex: -1, fontSize: global.fontSize, height: global.height, font: global.font, fontWeight: global.fontWeight },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { id: "spltText" }, sentence));
};
...
/*!************************!*\
  !*** ./src/reducer.ts ***!
  \************************/
/*! exports provided: storage, initStorage, getData, reducerFunc */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "reducerFunc", function() { return reducerFunc; });
...
const getData = async () => {
    return await readLocalStorage('splt_styles').then((result) => {
        if (!result) {
