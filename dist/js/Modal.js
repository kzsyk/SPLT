...
/* harmony import */ var _logics_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./logics/utils */ "./src/logics/utils.ts");
...
const ModalStyle = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div `
    ...
    z-index: ${props => props.isOpen ? _logics_utils__WEBPACK_IMPORTED_MODULE_2__["MAX_Z_INDEX"] : 0};
...
const Modal = (props) => {
    ...
    const color = Object(react__WEBPACK_IMPORTED_MODULE_0__["useMemo"])(() => props.color, [props]);
    ...
    const isOpenModal = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])((isOpen) => {
        setAutoFocus(isOpen);
    }, [setAutoFocus]);
